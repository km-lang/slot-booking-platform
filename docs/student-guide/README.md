...
<img src="screenshots/01-login.png" width="360" alt="Login page with Sign in with Google button" />
...
<img src="screenshots/02-dashboard.png" width="360" alt="Student dashboard showing search bar and preparation groups" />
...
<img src="screenshots/03-find-mentor.png" width="360" alt="Expanded Team Disha group listing individual mentors with open slot counts" />
...
<img src="screenshots/04-mentor-slots.png" width="360" alt="Mentor's page listing available 15-minute session slots with a Book button" />
...
<img src="screenshots/05-confirm-session.png" width="360" alt="Confirm Session sheet with focus selector and Lock In Booking button" />

Once confirmed, the slot updates immediately to show your booking:

<img src="screenshots/06-booking-confirmed.png" width="360" alt="Slot list showing the newly booked slot marked Overall CV Review with a Cancel option" />
...
<img src="screenshots/07-my-sessions.png" width="360" alt="My Sessions page listing one upcoming confirmed booking" />
...
<img src="screenshots/08-profile.png" width="360" alt="Profile page showing locked name/email and read-only Disha cohort assignment" />
