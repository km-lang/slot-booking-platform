...
|---|---|---|---|
| 2026-08-18 | `4ce50a3` | fix | Mentor utilization now weights offered hours by slot capacity — GD/CASE group slots (capacity > 1) were counting offered hours once per slot while completed hours counted once per attendee, inflating utilization past 100%; applies to `getBatchOverview`, `getOrgStats`, and `listMentorStats` |
